window.isDev = location.href.indexOf('/visual-ui') >= 0;
window.$website = {
  isDemo: false,
  isDemoTip: '演示环境不允许操作',
  title: '可视化数据大屏 - JeeSite',
  name: '可视化数据大屏',
  subName: 'v2.6',
  url: window.isDev ? '/js/visual' : '.',
  base: window.isDev ? '/visual-ui' : '.',
        ...
        data: [
          {
            ...
            date: "2022-05-22",
            dept: "设计部",
            img: "https://blade-data.oss-cn-hangzhou.aliyuncs.com/upload/20220522/6f2a92d95b64efeb42c131489abaff2f.webp"
          },
          {
            name: "smallwei",
            time: "11:26",
